...
export type TestStrategyEventArgs =
    | TestStrategyHarvestedEventArgs
    | TestStrategyUpdatedDebtThresholdEventArgs
    | TestStrategyUpdatedKeeperEventArgs
    | TestStrategyUpdatedProfitFactorEventArgs
    | TestStrategyUpdatedReportDelayEventArgs
    | TestStrategyUpdatedRewardsEventArgs
    | TestStrategyUpdatedStrategistEventArgs;

export enum TestStrategyEvents {
    Harvested = 'Harvested',
    UpdatedDebtThreshold = 'UpdatedDebtThreshold',
    UpdatedKeeper = 'UpdatedKeeper',
    UpdatedProfitFactor = 'UpdatedProfitFactor',
    UpdatedReportDelay = 'UpdatedReportDelay',
...
export interface TestStrategyUpdatedDebtThresholdEventArgs extends DecodedLogArgs {
    debtThreshold: BigNumber;
}

export interface TestStrategyUpdatedKeeperEventArgs extends DecodedLogArgs {
    newKeeper: string;
}

export interface TestStrategyUpdatedProfitFactorEventArgs extends DecodedLogArgs {
    profitFactor: BigNumber;
}

export interface TestStrategyUpdatedReportDelayEventArgs extends DecodedLogArgs {
    delay: BigNumber;
}

export interface TestStrategyUpdatedRewardsEventArgs extends DecodedLogArgs {
    rewards: string;
}

export interface TestStrategyUpdatedStrategistEventArgs extends DecodedLogArgs {
...
private readonly _subscriptionManager: SubscriptionManager<TestStrategyEventArgs, TestStrategyEvents>;
public static async deployFrom0xArtifactAsync(
        ...
        return TestStrategyContract.deployAsync(bytecode, abi, provider, txDefaults, logDecodeDependenciesAbiOnly, _vault
);
    }
    ...
    public static async deployAsync(
        ...
        logUtils.log(`TestStrategy successfully deployed at ${txReceipt.contractAddress}`);
        const contractInstance = new TestStrategyContract(txReceipt.contractAddress as string, provider, txDefaults, logDecodeDependencies);
...
> {
    ...
    public delegatedAssets(
    ): ContractTxFunctionObj<BigNumber
> {
        const self = this as any as TestStrategyContract;
        const functionSignature = 'delegatedAssets()';
...
> {
        ...
        return {
            ...
            getABIEncodedTransactionData(): string {
                return self._strictEncodeArguments(functionSignature, [_newStrategy.toLowerCase()
            ]);
            },
        }
    };
    public minReportDelay(
    ): ContractTxFunctionObj<BigNumber
> {
        const self = this as any as TestStrategyContract;
...
> {
        ...
        return {
            ...
            getABIEncodedTransactionData(): string {
                return self._strictEncodeArguments(functionSignature, [_keeper.toLowerCase()
            ]);
            },
        }
    };
    public setMinReportDelay(
            _delay: BigNumber,
    ): ContractTxFunctionObj<void
> {
        const self = this as any as TestStrategyContract;
...
> {
        ...
        return {
            ...
            getABIEncodedTransactionData(): string {
                return self._strictEncodeArguments(functionSignature, [_rewards.toLowerCase()
            ]);
            },
        }
    };
    public setStrategist(
            _strategist: string,
    ): ContractTxFunctionObj<void
> {
        const self = this as any as TestStrategyContract;
        ...
        return {
            ...
            getABIEncodedTransactionData(): string {
                return self._strictEncodeArguments(functionSignature, [_strategist.toLowerCase()
            ]);
            },
        }
    };
...
> {
    ...
    constructor(
        ...
        super('TestStrategy', TestStrategyContract.ABI(), address, supportedProvider, txDefaults, logDecodeDependencies, deployedBytecode);
        classUtils.bindAll(this, ['_abiEncoderByFunctionSignature', 'address', '_web3Wrapper']);
this._subscriptionManager = new SubscriptionManager<TestStrategyEventArgs, TestStrategyEvents>(
            TestStrategyContract.ABI(),
            this._web3Wrapper,
        );
